        ...
        return (
          ...
          >
            <svg
              ...
              className={`
                w-10 h-10 transition-transform duration-200 ease-in-out
                ${starValue <= (hover || rating)
                  ? 'text-[#3F978F] fill-[#3F978F]'
                  : 'text-black dark:text-gray-100 fill-none'}
...
const TypingSlogan = () => {
  ...
  return (
    <h2 className="text-5xl md:text-5xl lg:text-6xl font-bold mb-6 md:mb-10 font-bodoni tracking-wide text-left w-full text-black dark:text-gray-100">
      {beforeSimple}
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white dark:bg-gray-900">
      ...
      <div className="flex-1 flex flex-col lg:flex-row p-4 md:p-8 gap-8 mt-24 md:mt-20">
        ...
        <div className="w-full lg:w-1/3 flex flex-col items-center mb-8 lg:mb-0 lg:-mt-24">
          <div className="w-full max-w-xs sm:max-w-sm md:max-w-[350px] lg:max-w-[350px]">
            <div className="bg-gray-200 dark:bg-gray-800 rounded-xl md:rounded-2xl lg:rounded-3xl overflow-hidden aspect-[3/4] h-auto max-h-[500px]">
              <img 
                src="/outfit.jpg" 
                alt="Selected outfit" 
        ...
        <div className="w-full lg:w-1/3 flex justify-center mt-0 lg:-mt-20">
          <div className="relative w-full max-w-[280px]">
            {/* Arch Border */}
            <div className="absolute inset-0 border border-black dark:border-gray-600 rounded-tl-full rounded-tr-full h-full -top-[4%] pointer-events-none"></div>

            {/* Content */}
            <div className="relative z-10 pt-10 pb-6 px-4">
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-livvic text-center mb-6 md:mb-8 text-black dark:text-gray-100">
                Upcoming Events
              </h2>
