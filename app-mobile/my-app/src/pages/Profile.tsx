              ...
              <div className="grid grid-cols-3 gap-2 sm:gap-3">
                {topOutfits.map((outfit) => (
                  <motion.div
                    ...
                    className="relative bg-white rounded-xl p-4 w-full cursor-pointer shadow-lg hover:shadow-2xl transition-shadow duration-300"
                  >
                    ...
                    <button
                      ...
                      className="absolute top-2 right-2 text-white bg-black/50 rounded-full p-1 opacity-0 group-hover:opacity-100 transition"
                    >
